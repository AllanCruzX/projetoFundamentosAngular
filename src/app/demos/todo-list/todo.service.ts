...
export class TasksService {
  ...
  //getTodoList$ - propriedade
  //TODO: O getTodoList$ so vai ser chamado quando precisar alimentar o Store
  //O metodo tap e pareceido com map , ele serve para trabalhar com Observable
